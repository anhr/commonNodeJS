...
//				let dist = Math.sqrt(dx * dx + dy * dy + dz * dz);
				...
				const noise1 = utils.anglesToCartesian(RandomVertice.get(arc, utils.angles(overrides.angles(angles1)), classSettings, RandomVertice), r);
...
//				const noise2 = utils.anglesToCartesian(RandomVertice.get(arc, utils.angles([angles2[0], angles2[1]]), classSettings, RandomVertice), r);
				const noise2 = utils.anglesToCartesian(RandomVertice.get(arc, utils.angles(overrides.angles(angles2)), classSettings, RandomVertice), r);
