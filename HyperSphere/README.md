...
If you click the ► button in the lower left corner of the canvas, you will start iterative process in which is resolving the [Thomson Problem](docs/ThomsonProblem.md), at each step, all vertices gradually move toward a position in which the vertices are at the maximum distance from each other.
