...
*
* http://www.apache.org/licenses/LICENSE-2.0
*/function Pe(){S(this,Pe)}window.__myThree__=window.__myThree__||{},window.__myThree__.boThree?_t=window.__myThree__.three:((_t=new X).isThree=function(){return Oe},window.__myThree__.boThree=!0,window.__myThree__.three=_t);var Le=_t,Re=(v(Me,C.CustomController),Me);
/**
 ...
 * http://www.apache.org/licenses/LICENSE-2.0
*/
function wn(E,C){var S=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{},e=Le.THREE;C=C||new e.Vector3(0,0,0);var T=new e.Sprite(new e.SpriteMaterial({map:new e.Texture,sizeAttenuation:void 0!==S.sizeAttenuation&&S.sizeAttenuation})),O=document.createElement("canvas");T.material.map.minFilter=e.LinearFilter;var k=O.getContext("2d");return S.name&&(T.name=S.name),T.userData.update=function(){var e={};T.parent?xn(T.parent,e):S.group&&xn(S.group,e);var t=S.textHeight||e.textHeight||.04,n=S.fov||e.fov,o=S.sizeAttenuation||e.sizeAttenuation||!1,i=S.rotation||e.rotation||0,r=S.fontFace||e.fontFace||"Arial",a=S.bold||e.bold||!1,s=S.italic||e.italic||!1,l=S.fontProperties||e.fontProperties||"",c=S.rect||e.rect||{},u=S.fontColor||e.fontColor||"rgba(255, 255, 255, 1)",e=wn.getCenter(S.center||e.center,C);void 0!==n&&(t=n*t/50),c.displayRect=c.displayRect||!1;var d=c.borderThickness||5,r=l+(a?"bold ":"")+(s?"italic ":"")+"90px "+r;k.font=r;var p,f,h,m,_,g,b,v=0,y=1;if("string"==typeof E?(y=0,(p=E.split(/\r\n|\r|\n/)).forEach(function(e){e=k.measureText(e).width;v<e&&(v=e),y+=1})):v=k.measureText(E).width,v+=2*d,O.width=v,O.height=90*y+2*d,k.font=r,c.displayRect&&(k.fillStyle=c.backgroundColor||"rgba(0, 0, 0, 1)",k.strokeStyle=c.borderColor||u,k.lineWidth=d,f=k,m=h=d/2,_=O.width-d,g=O.height-d,b=void 0===c.borderRadius?0:c.borderRadius,f.beginPath(),f.moveTo(h+b,m),f.lineTo(h+_-b,m),f.quadraticCurveTo(h+_,m,h+_,m+b),f.lineTo(h+_,m+g-b),f.quadraticCurveTo(h+_,m+g,h+_-b,m+g),f.lineTo(h+b,m+g),f.quadraticCurveTo(h,m+g,h,m+g-b),f.lineTo(h,m+b),f.quadraticCurveTo(h,m,h+b,m),f.closePath(),f.fill(),f.stroke()),k.fillStyle=u,k.textBaseline="bottom",1<y)for(var w=0;w<p.length;w++){var x=p[w];k.fillText(x,d,O.height-90*(p.length-w-1)-d)}else k.fillText(E,d,O.height-d);T.material.map.image=O,T.material.map.needsUpdate=!0;t*=y;T.scale.set(t*O.width/O.height,t),T.position.copy(C),T.center=e,T.material.sizeAttenuation=o,T.material.rotation=i,T.material.needsUpdate=!0},T.userData.update(),T.userData.updateText=function(e){E=e;e={};xn(T.parent,e),T.userData.update(e)},S.group&&S.group.add(T),T.userData.optionsSpriteText=S,T}function xn(t,n){for(t.userData.optionsSpriteText&&Object.keys(t.userData.optionsSpriteText).forEach(function(e){void 0===n[e]&&(n[e]=t.userData.optionsSpriteText[e])});t.parent;)xn(t=t.parent,n)}yn.RendererSetSize=function(r,a){r.setSizeOld||(r.setSizeOld=r.setSize,r.setSize=function(e,t,n){r.setSizeOld(e,t,n);var o=r.domElement,i=o.parentElement;setTimeout(function(){i.style.height=o.style.height,i.style.width=o.style.width,i.style.left=o.style.left,i.style.top=o.style.top,i.style.position=o.style.position,a&&a.setSize(e,t)},0)})},wn.getCenter=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=arguments[1],n=Le.THREE,o=e.canvas||void 0;var i,r,a,s=e.canvas?(i=o.width/2,r=o.height/2,(a=(new n.Vector3).copy(t)).project(e.camera),a.x=a.x*i+i,a.y=-a.y*r+r,a):void 0;return e instanceof n.Vector2||"object"===(void 0===e?"undefined":x(e))&&void 0!==e.x&&void 0!==e.y?e:s?new n.Vector2(s.x<o.width/2?0:1,s.y<o.height/2?1:0):new n.Vector2(0,1)},wn.updateSpriteTextGroup=function(e){var t=Le.THREE;e.children.forEach(function(e){e instanceof t.Sprite&&void 0!==e.userData.update&&e.userData.update(),wn.updateSpriteTextGroup(e)})};
/**
 * @module StereoEffect
