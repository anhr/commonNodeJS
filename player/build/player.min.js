 ...
 * http://www.apache.org/licenses/LICENSE-2.0
 */
var An=function n(o){var f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};S(this,n),Ln(),!f.options&&f.frustumPoints&&(f.options=f.frustumPoints.getOptions()),f.options=f.options||new Tn;var i,r,u,a,s,d,l,h=f.options;function t(e){e=e||0;var t=r.getTime();n.selectPlayScene(o,{t:t,index:e,options:f.options}),r.setIndex(e,(""===h.playerOptions.name?"":h.playerOptions.name+": ")+t),f.onSelectScene&&f.onSelectScene(e,t),h.frustumPoints&&h.frustumPoints.updateCloudPoints()}function e(){h.player.controllers.forEach(function(e){e.onRenamePlayButtons&&e.onRenamePlayButtons(u)})}function c(){u=!1,e(),a=void 0}function p(){if(i++,null!==h.playerOptions.max&&i>=h.playerOptions.marks){if(!h.playerOptions.repeat)return i=h.playerOptions.marks-1,void c();i=0}(-1===i||i===h.playerOptions.marks&&null!==h.playerOptions.max)&&(i=0),t(i)}function m(e){"ru"===e()&&(d.prevSymbolTitle="Кадр назад",d.playTitle="Проиграть",d.nextSymbolTitle="Кадр вперед",d.pauseTitle="Пауза",d.repeatOn="Повторять проигрывание",d.repeatOff="Остановить повтор проигрывания",d.controllerTitle="Текущее время.",d.stereoEffects="Стерео эффекты",d.mono="Моно",d.sideBySide="Слева направо",d.topAndBottom="Сверху вниз")}function _(e){S(this,_);var i,r,a=h.player,t=h.getLanguageCode;if(!(e=e||h.dat.gui)||!1===h.dat.playController){var n=y(this,(_.__proto__||Object.getPrototypeOf(_)).call(this,{}));return y(n)}function s(e,t,n){var o=document.createElement("span");return o.innerHTML=e,o.title=t,o.style.cursor="pointer",o.style.margin="0px 2px",o.onclick=n,o}m(t);var l="rgb(255,255,255)",c="rgb(128,128,128)",n=y(this,(_.__proto__||Object.getPrototypeOf(_)).call(this,{playRate:1,property:function(){var e,t,n,o={};return i=function(e,t){o.buttonPlay.innerHTML=e,o.buttonPlay.title=t},o.buttonPrev=s(d.prevSymbol,d.prevSymbolTitle,a.prev),o.buttonPlay=s(u?d.pause:d.playSymbol,u?d.pauseTitle:d.playTitle,a.play3DObject),null!==a.getSettings().options.playerOptions.max&&(r=e=function(e){var t,n=e?(t=d.repeatOff,l):(t=d.repeatOn,c);o.buttonRepeat.title!==t&&(o.buttonRepeat.title=t,o.buttonRepeat.style.color=n,a.onChangeRepeat(e))},n=a.getSettings().repeat?(t=d.repeatOff,l):(t=d.repeatOn,c),o.buttonRepeat=s(d.repeat,t,function(){e(o.buttonRepeat.title===d.repeatOn)}),o.buttonRepeat.style.color=n),o.buttonNext=s(d.nextSymbol,d.nextSymbolTitle,a.next),o}},"playRate"));return(a.PlayController=n).lang=d,n.onRenamePlayButtons=function(e){var t,e=e?(t=d.pause,d.pauseTitle):(t=d.playSymbol,d.playTitle);i(t,e,!0)},n.onChangeRepeat=function(){r(a.getSettings().options.playerOptions.repeat)},a.pushController(n),n.setValue=function(e){this._controller.domElement.childNodes[0].value=e},e.add(n).__truncationSuspended=!0,y(n)}function g(){if(l)return l.querySelector("#sliderPosition")}h.boOptions?!1!==h.player&&(h.boPlayer=h.boPlayer||!1,h.player?console.error("Player: duplicate player."):(h.player=this,f.cameraTarget=f.cameraTarget||{},setTimeout(function(){t()},0),i=0,(r=this).getTime=function(){var e=h.playerOptions,t=e.min+i*e.dt;return isNaN(t)&&console.error("Player.getTime(): t = "+t),null!==e.max&&t>e.max&&console.error("Player.getTime(): t = "+t+" playerOptions.max = "+e.max),t<e.min&&null!==e.max&&console.error("Player.getTime(): t = "+t+" playerOptions.min = "+e.min),t},this.setTime=function(e){this.selectScene(parseInt((e-h.playerOptions.min)/h.playerOptions.dt))},this.selectScene=function(e){if(void 0!==e)for(e=parseInt(e),null!==h.playerOptions.max&&(e>=h.playerOptions.marks?e=0:e<0&&(e=h.playerOptions.marks-1),i>h.playerOptions.marks&&(i=h.playerOptions.marks));i!==e;)i<e?i++:i--,t(i);else t(i)},this.next=function(){r.selectScene(i+1)},this.prev=function(){r.selectScene(i-1)},this.pushController=function(e){void 0!==e.object&&void 0!==e.object.playRate&&(e.object.playRate=h.playerOptions.min),this.controllers.push(e)},u=!(this.controllers=[]),this.play3DObject=function(){u?c():(u=!0,null!==h.playerOptions.max&&i>=h.playerOptions.marks-1&&(i=0),p(),e(),window.requestAnimationFrame(function e(t){if(u?window.requestAnimationFrame(e):a=void 0,void 0===a&&(s=(a=t)+1e3/h.playerOptions.interval),!isNaN(s)&&s!==1/0||(console.error("Player.animate: timeNext = "+s),u=!1),!(t<s)){for(;s<t;)s+=1e3/h.playerOptions.interval;p()}}))},this.repeat=function(){h.playerOptions.repeat=!h.playerOptions.repeat,this.onChangeRepeat(h.playerOptions.repeat)},this.getSettings=function(){return f},this.getSelectSceneIndex=function(){return i},this.onChangeRepeat=function(e){h.playerOptions.repeat=e,this.controllers.forEach(function(e){e.onChangeRepeat&&e.onChangeRepeat()})},d={prevSymbol:"←",prevSymbolTitle:"Go to previous animation scene",nextSymbol:"→",nextSymbolTitle:"Go to next animation scene",playSymbol:"►",playTitle:"Play",pause:"❚❚",pauseTitle:"Pause",repeat:"⥀",repeatOn:"Turn repeat on",repeatOff:"Turn repeat off",controllerTitle:"Current time.",stereoEffects:"Stereo effects",mono:"Mono",sideBySide:"Side by side",topAndBottom:"Top and bottom"},this.localization=function(){return m(0<arguments.length&&void 0!==arguments[0]?arguments[0]:function(){return"en"}),d},this.PlayController=(v(_,Qt.CustomController),b(_,[{key:"controller",set:function(e){this._controller=e,this._controller.onChange(function(e){h.player.setTime(e)}),this._controller.domElement.title=this.lang.controllerTitle},get:function(){return this._controller}}]),_),this.gui=function(e){var i,r,t,n,a,o=h.dat.cookie,s=h.dat.getCookieName("Player"),l=h.getLanguageCode,c=Le.dat;function u(){null===h.playerOptions.max?h.playerOptions.dt=h.playerOptions.dt||.1:h.playerOptions.dt=(h.playerOptions.max-h.playerOptions.min)/(h.playerOptions.marks-1)}function d(){u(),o.setObject(s,h.playerOptions),f.onChangeScaleT&&f.onChangeScaleT(h.playerOptions)}function p(){null!==h.playerOptions.max&&(h.playerOptions.max=h.playerOptions.min+h.playerOptions.dt*(h.playerOptions.marks-1))}(e=e||h.dat.gui)&&!1!==h.dat.playerGui&&(p(),i=JSON.parse(JSON.stringify(h.playerOptions)),r=function(t){var e={player:"Player",playerTitle:"3D objects animation.",min:"Min",max:"Max",dt:"Step",dtTitle:"Time between frames",marks:"Frames",marksTitle:"Player frames count",interval:"Rate",intervalTitle:"Rate of changing of animation scenes per second.",time:"Time",defaultButton:"Default",defaultTitle:"Restore default player settings."},n=void 0===(t=t||{}).getLanguageCode?"en":t.getLanguageCode();switch(n){case"ru":e.player="Проигрыватель",e.playerTitle="Анимация 3D объектов.",e.min="Минимум",e.max="Максимум",e.dt="Шаг",e.dtTitle="Веремя между кадрами",e.marks="Кадры",e.marksTitle="Количество кадров проигрывателя",e.interval="Темп",e.intervalTitle="Скорость смены кадров в секунду.",e.time="Время",e.defaultButton="Восстановить",e.defaultTitle="Восстановить настройки проигрывателя по умолчанию.";break;default:if(void 0===t.lang||t.lang._languageCode!=n)break;Object.keys(t.lang).forEach(function(e){void 0!==_lang[e]&&(_lang[e]=t.lang[e])})}return e}({getLanguageCode:l}),Object.freeze(i),t=h.playerOptions.max,n=h.playerOptions.marks,o.getObject(s,h.playerOptions,h.playerOptions),null!==t&&t!==1/0&&null!==h.playerOptions.max||(h.playerOptions.max=t,h.playerOptions.marks=n),a=e.addFolder(r.player),c.folderNameAndTitle(a,r.player,r.playerTitle),function(){var n=h.playerOptions,o={};function e(e,t){e=e.controller.getValue();n.min=t(n.min,e),o.min.setValue(n.min),n.max&&(n.max=t(n.max,e),u(),o.max.setValue(n.max)),d()}o.folder=a.addFolder(""!==n.name?n.name:r.time),o.scaleController=o.folder.add(new Re(e,{settings:f.options.playerOptions,getLanguageCode:l})).onChange(function(e){n.zoomMultiplier=e,d()});var t=new Ne(function(n){e(t,function(e,t){return e+=n})},{settings:f.options.playerOptions,getLanguageCode:l});o.positionController=o.folder.add(t).onChange(function(e){n.offset=e,d()}),o.min=c.controllerZeroStep(o.folder,n,"min",function(e){d()}),c.controllerNameAndTitle(o.min,r.min),p(),null!==n.max?(o.max=c.controllerZeroStep(o.folder,n,"max",function(e){d()}),c.controllerNameAndTitle(o.max,r.max)):(o.dt=c.controllerZeroStep(o.folder,n,"dt",function(e){d()}),c.controllerNameAndTitle(o.dt,r.dt,r.dtTitle)),n.marks&&(o.marks=o.folder.add(n,"marks").onChange(function(e){n.marks=parseInt(n.marks),d();var t=g();t&&(t.max=h.playerOptions.marks-1)}),c.controllerNameAndTitle(o.marks,void 0===n.marksName?r.marks:n.marksName,(void 0===n.marksTitle?r:n).marksTitle)),o.interval=o.folder.add(f.options.playerOptions,"interval",1,25,1).onChange(function(e){d()}),c.controllerNameAndTitle(o.interval,r.interval,r.intervalTitle),c.controllerNameAndTitle(o.folder.add({defaultF:function(){n.zoomMultiplier=i.zoomMultiplier,o.scaleController.setValue(n.zoomMultiplier),n.offset=i.offset,o.positionController.setValue(n.offset),n.min=i.min,o.min.setValue(n.min),o.max&&(n.max=i.max,u(),o.max.setValue(n.max)),o.dt&&(n.dt=i.dt,o.dt.setValue(n.dt)),i.marks&&(n.marks=i.marks,o.marks&&o.marks.setValue(n.marks)),n.interval=i.interval,o.interval.setValue(n.interval),d()}},"defaultF"),r.defaultButton,r.defaultTitle)}())},this.createCanvasMenuItem=function(o){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:function(){return"en"},t=this,n=(l=o).menu,i=t.localization(e);n.push({name:i.prevSymbol,title:i.prevSymbolTitle,onclick:function(){t.prev()}}),n.push({name:u?i.pause:i.playSymbol,title:u?i.pauseTitle:i.playTitle,id:"menuButtonPlay",onclick:function(){t.play3DObject()}}),null!==h.playerOptions.max&&n.push({name:i.repeat,title:this.getSettings().repeat?i.repeatOff:i.repeatOn,id:"menuButtonRepeat",onclick:function(){t.repeat()}}),n.push({name:i.nextSymbol,title:i.nextSymbolTitle,onclick:function(){t.next()}}),this.controllers.push({onRenamePlayButtons:function(e){var t,n=e?(t=i.pause,i.pauseTitle):(t=i.playSymbol,i.playTitle),e=o.querySelector("#menuButtonPlay");e.innerHTML=t,e.title=n},onChangeRepeat:function(){o.querySelector("#menuButtonRepeat").title=h.playerOptions.repeat?i.repeatOff:i.repeatOn}})},this.addSlider=function(){null!==h.playerOptions.max&&l.menu.push({name:'<input type="range" min="0" max="'+(h.playerOptions.marks-1)+'" value="0" class="slider" id="sliderPosition">',style:"float: right;"})},this.addSliderEvents=function(){var t,n,o=g();return o&&(o.onchange=function(e){n.selectScene(parseInt(o.value))},o.oninput=function(e){n.selectScene(parseInt(o.value))},n=this,o.addEventListener("pointerdown",function(e){t=!0}),o.addEventListener("pointerup",function(e){t=!1}),o.addEventListener("mousemove",function(e){t&&n.selectScene((h.playerOptions.marks-1)*e.offsetX/o.clientWidth)})),o},this.setIndex=function(e,t){"object"===x(this.PlayController)&&this.PlayController.setValue(this.getTime());var n=g();n&&(n.value=e,n.title=t)},this.onChangeScale=function(e){g().max=e.marks-1,this.selectScene(0)})):console.error("Player: call options = new Options( options ) first")};An.cameraTarget=function e(){S(this,e);var i,o={boLook:!1},t={boLook:o.boLook,getDistanceToCamera:function(){return void 0!==this.distanceToCameraCur?this.distanceToCameraCur:this.distanceToCamera}};o.rotation={};var r,a=(t.rotation={},!1),n=!1;function s(e){Ln(),e=e||o,t.boMaual||(void 0!==e.boLook?t.boLook=e.boLook:t.boLook=o.boLook),t.camera=e.camera||o.camera,t.distanceToCamera=e.distanceToCamera||o.distanceToCamera||t.distanceToCamera||(new kn.Vector3).copy(o.camera.position),e.rotation||(e.rotation={}),void 0!==e.rotation.angle?t.rotation.angle=e.rotation.angle:t.rotation.angle=o.rotation.angle||0,t.rotation.axis=e.rotation.axis||o.rotation.axis||new kn.Vector3(0,1,0)}this.get=function(e){if(e||i?i&&e&&!Object.is(i,e)&&console.error("Player.cameraTarget.get: options is ambiguous"):console.error("Player.cameraTarget.get: options = "+e),i=i||e,t.camera||n||!i.player||(o.camera=i.player.getSettings().cameraTarget.camera,o.camera&&s(),n=!0),t.camera)return t},this.init=function(e,t){var n=!(2<arguments.length&&void 0!==arguments[2])||arguments[2];if(e){if(t||i?i&&t&&!Object.is(i,t)&&console.error("Player.cameraTarget.init: options is ambiguous"):console.error("Player.cameraTarget.init: options = "+t),i=i||t,!1!==e.bodefault){if(a)return;void 0!==e.boLook&&(o.boLook=e.boLook,r=e.boLook)}else{if(!0!==e.boLook)return;a&&console.warn("playerCameraTarget().init(...): duplicate target point"),a=!0,void 0===r&&(o.boLook=!0)}o.camera=o.camera||e.camera||(i.player?i.player.getSettings().cameraTarget.camera:void 0),o.camera||!n?(o.distanceToCamera=o.distanceToCamera||e.distanceToCamera,e.rotation=e.rotation||{},o.rotation.angle=o.rotation.angle||e.rotation.angle,o.rotation.axis=o.rotation.axis||e.rotation.axis,s(e)):console.error("playerCameraTarget().init(...): cameraTargetDefault.camera = "+o.camera)}},this.changeTarget=function(e,t){Ln();var n=i.playerOptions.cameraTarget.get(),o=e.userData.player&&"function"!=typeof e.userData.player.arrayFuncs?e.userData.player.arrayFuncs[t]:{};o.cameraTarget||(o.cameraTarget={boLook:!1}),s(o.cameraTarget),n&&n.boLook?(e=$t(e,(new kn.Vector3).fromArray(e.geometry.attributes.position.array,t*e.geometry.attributes.position.itemSize)),n.target=e):delete n.target},this.setCameraTarget=function(n){Ln();var e,t,o,i=n.playerOptions.cameraTarget.get(n),r=(i=i||i||{}).camera;r&&(i.distanceToCamera||(i.distanceToCamera=(new kn.Vector3).copy(r.position)),i.distanceToCameraCur||(i.distanceToCameraCur=new kn.Vector3),e=n.time,t=i.distanceToCamera,o=(new kn.Vector3).copy(i.distanceToCameraCur),i.distanceToCameraCur.set(An.execFunc(t,"x",e,n),An.execFunc(t,"y",e,n),An.execFunc(t,"z",e,n)),i.setCameraPosition||(i.setCameraPosition=function(){var e=i.target;if(i.boLook&&(e||!i.distanceToCameraCur.equals(o))){o.copy(i.distanceToCameraCur);var t=n.time;if(r.position.copy(i.distanceToCameraCur),r.position.applyAxisAngle(i.rotation.axis,An.execFunc(i.rotation,"angle",t,n)),!e){if(!An.orbitControls)return;e=An.orbitControls.target}r.position.add(e),r.lookAt(e),n.orbitControls&&(n.orbitControls.target.equals(e)||(n.orbitControls.target.copy(e),n.orbitControlsGui&&n.orbitControlsGui.setTarget(e)),n.orbitControls._listeners&&n.orbitControls._listeners.change[0]())}}),n.cameraGui&&n.cameraGui.update())}},An.execFunc=function(e,t,n){var o=3<arguments.length&&void 0!==arguments[3]?arguments[3]:{},i=e[t],r=o.a,a=o.b,s=void 0===i?"undefined":x(i);switch(void 0===n&&(n=o.playerOptions?o.playerOptions.min:0),s){case"undefined":return;case"number":return i;case"string":i=new Function("t","a","b","return "+i);case"function":try{var l=i(n,r,a);if(void 0===l)throw"function returns "+l;if(!Array.isArray(l))return l;i=l}catch(e){throw console.error(e),e}case"object":if(Array.isArray(i)){var c=function(e){return"function"==typeof u[e]?u[e](n,u,a):u[e]instanceof kn.Color?u[e]:void 0};if(0===i.length)return void console.error('Player.execFunc: funcs["'+t+'"] array is empty');for(var u=i,d=i.length-1,p=null===o.playerOptions.max?1/0:o.playerOptions.max,f=o.playerOptions.min,h=(p-f)/d,m=f,_=p,g=0,b=d,v=0;v<i.length;v++)h*v+f<n&&(m=h*(g=v)+f,_=h*(b=v+1)+f);if("number"!=typeof u[g]){if("w"===t)return c(g);if("object"!==x(u[g]))return void console.error('Player.execFunc: funcs["'+t+'"] array item '+g+" typeof = "+x(u[g])+" is not number");for(v=0;v<i.length;v++){if(v===i.length-1)return u[v].v;if(b=(g=v)+1,m=u[g].t,_=u[b].t,m<=n&&n<_){var y=(u[b].v-u[g].v)/(_-m),w=u[g].v-y*m;return y*n+w}}return void console.error("Player.execFunc: value is not detected")}if(b>=i.length&&(b=g),"number"!=typeof u[b]){if("w"===t)return c(b);if("object"!==x(u[b]))return void console.error('Player.execFunc: funcs["'+t+'"] array item '+b+" typeof = "+x(u[b])+" is not number")}y=(u[b]-u[g])/(_-m),w=u[g]-y*m;return(isNaN(y)||isNaN(w))&&console.error("Player.execFunc: invalid x = "+y+" or y = "+w),y*n+w}return i.func?i.func instanceof Function?i.func(n,r,a):i.func:("w"!==t&&console.error('Player.execFunc: funcs["'+t+'"] object is not array'),i);default:console.error('Player.execFunc: Invalud typeof funcs["'+t+'"]: '+s)}},An.selectMeshPlayScene=function(f){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};Ln();var t,h=e.t,m=e.options||{dat:!1};void 0===h&&(h=m.playerOptions.min),m.scales.setW(),!f.userData.player||m&&m.boPlayer&&f.userData.boFrustumPoints||(f.geometry&&(delete f.geometry.boundingSphere,f.geometry.boundingSphere=null),f.userData.player.selectPlayScene&&(t=function(e){for(;f.rotation[e]<0;)f.rotation[e]+=2*Math.PI;for(;f.rotation[e]>2*Math.PI;)f.rotation[e]-=2*Math.PI},f.userData.player.selectPlayScene(h),t("x"),t("y"),t("z")),function(n,i){if(f.geometry){var r,a,s=f.geometry.attributes,l=f.userData.player.arrayFuncs;if(void 0!==l){void 0===h&&console.error("setPosition: t = "+h),m&&void 0!==m.scales.w?(r=m.scales.w.min,a=m.scales.w.max):r=(a=d)-1;for(var c,u,d,p=0;p<l.length;p++)!function(){function e(e,t){e=An.execFunc(c,e,h,m);void 0!==e&&(s.position[t](p,e),u=!0)}c=l[p],u=!1,e("x","setX"),e("y","setY"),e("z","setZ");var o=void 0;function t(){if(f.userData.player.palette)o=f.userData.player.palette.toColor(d,r,a);else{if(!m.palette){var e=255,t=255,n=255;return o=new kn.Color("rgb("+e+", "+t+", "+n+")")}o=m.palette.toColor(d,r,a)}}"function"==typeof c.w?(d=c.w(h,n,i),a=m.scales.w?(r=m.scales.w.min,m.scales.w.max):(console.warn("Player.selectMeshPlayScene: Кажется эти экстремумы заданы неверно"),r=0,100),4<=s.position.itemSize&&s.position.setW(p,d),u=!0,t()):"object"===x(c.w)?c.w instanceof kn.Color?o=c.w:(d=An.execFunc(c,"w",h,m),void 0!==c.w.min&&(r=c.w.min),void 0!==c.w.max&&(a=c.w.max),t()):"number"==typeof c.w&&m.palette&&(o=m.palette.toColor(c.w,r,a)),o&&(!f.material instanceof kn.ShaderMaterial&&f.material.vertexColors!==kn.VertexColors&&console.error("Player.selectMeshPlayScene: Please set the vertexColors parameter of the THREE.PointsMaterial of your points to THREE.VertexColors. Example: vertexColors: THREE.VertexColors"),!An.setColorAttribute(s,p,o)&&c instanceof kn.Vector4&&(f.geometry.setAttribute("color",new kn.Float32BufferAttribute(An.getColors(l,{positions:f.geometry.attributes.position,options:m}),4)),An.setColorAttribute(s,p,o)||console.error('Player.selectMeshPlayScene: the color attribute is not exists. Please use THREE.Vector3 instead THREE.Vector4 in the arrayFuncs or add "color" attribute'))),u&&(s.position.needsUpdate=!0),c.line&&c.line.addPoint&&c.line.addPoint(f,p,o),c.cameraTarget&&!0===c.cameraTarget.boLook&&m.playerOptions.cameraTarget.changeTarget(f,p)}()}}}(m?m.a:1,m?m.b:0),t="Player.selectMeshPlayScene: invalid mesh.scale.",f.scale.x<=0&&console.error(t+"x = "+f.scale.x),f.scale.y<=0&&console.error(t+"y = "+f.scale.y),f.scale.z<=0&&console.error(t+"z = "+f.scale.z),m&&m.guiSelectPoint&&(m.guiSelectPoint.setMesh(),-1!==(t=m.guiSelectPoint.getSelectedPointIndex())&&m.guiSelectPoint.isSelectedMesh(f)&&m.guiSelectPoint.setPosition({object:f,index:t})))},An.setColorAttribute=function(e,t,n){"string"==typeof n&&(n=new kn.Color(n));e=e.color||e.ca;return void 0!==e&&(e.setX(t,n.r),e.setY(t,n.g),e.setZ(t,n.b),e.needsUpdate=!0)},An.getPoints=function(t,n){Ln(),Array.isArray(t)||(t=[t]),void 0===(n=n||{}).t&&(n.t=n.options&&n.options.player?n.options.player.getSettings().options.playerOptions.min:0);var o=n.options||new Tn,e={palette:o.palette};o.setW(e);for(var i=e.scales.w.max,r=0;r<t.length;r++){var a=t[r];Array.isArray(a)?t[r]=new kn.Vector4(void 0===a[0]?0:a[0],void 0===a[1]?0:a[1],void 0===a[2]?0:a[2],void 0===a[3]?i:a[3]):"object"===(void 0===a?"undefined":x(a))&&a instanceof kn.Vector2==!1&&a instanceof kn.Vector3==!1&&a instanceof kn.Vector4==!1&&(void 0===a.vector?t[r]=new kn.Vector4(void 0===a.x?0:a.x,void 0===a.y?0:a.y,void 0===a.z?0:a.z,void 0===a.w?0:a.w):a.vector instanceof kn.Vector2==!0||a.vector instanceof kn.Vector3==!0||a.vector instanceof kn.Vector4==!0?a.vector instanceof kn.Vector2==!0&&(t[r].vector=new kn.Vector3(void 0===a.vector.x?0:a.vector.x,void 0===a.vector.y?0:a.vector.y,void 0===a.vector.z?0:a.vector.z)):4===a.vector.length?t[r].vector=new kn.Vector4(void 0===a.vector[0]?0:a.vector[0],void 0===a.vector[1]?0:a.vector[1],void 0===a.vector[2]?0:a.vector[2],void 0===a.vector[3]?0:a.vector[3]):3===a.vector.length?t[r].vector=new kn.Vector3(void 0===a.vector[0]?0:a.vector[0],void 0===a.vector[1]?0:a.vector[1],void 0===a.vector[2]?0:a.vector[2]):console.error("Player.getPoints(...) falied! item.vector.length = "+a.vector.length))}for(var s=[],r=0;r<t.length;r++){var l=function(e){return"number"==typeof c&&(c=new kn.Vector4(c,0,0,0)),c instanceof kn.Vector2||c instanceof kn.Vector3||c instanceof kn.Vector4?An.execFunc(c,e,n.t,o):void 0!==c.vector?(void 0!==c.name&&(c.vector.name=c.name),c.trace&&o.player&&(c.vector.line=new An.traceLine(o)),c.cameraTarget&&(c.vector.cameraTarget=c.cameraTarget,delete c.cameraTarget),t[r]=c.vector,c=c.vector,An.execFunc(c,e,n.t,o)):void console.error("Player.getAxis().getPoints(): funcs.vector = "+c.vector)},c=t[r],l=c.vector instanceof kn.Vector3==!0?new kn.Vector3(l("x"),l("y"),l("z")):new kn.Vector4(l("x"),l("y"),l("z"),l("w"));c.cameraTarget&&(c.cameraTarget.bodefault=!1,void 0===c.cameraTarget.boLook&&(c.cameraTarget.boLook=!0),o.playerOptions.cameraTarget.init(c.cameraTarget,o)),s.push(l)}return s};var kn,Pn=!0;function Ln(){Le.isThree()?(kn=Le.THREE,Object.assign(kn.BufferGeometry.prototype,{setFromPoints:function(e,t){t=t||3;for(var n=[],o=0,i=e.length;o<i;o++){var r=e[o];n.push(r.x,r.y,r.z||0),4<=t&&n.push(r.w||0)}return this.setAttribute("position",new kn.Float32BufferAttribute(n,t)),this}}),Object.assign(kn.Vector4.prototype,{multiply:function(e){return this.x*=e.x,this.y*=e.y,this.z*=e.z,void 0!==e.w&&(this.w*=e.w),this}}),Object.assign(kn.Vector4.prototype,{add:function(e,t){return void 0!==t?(console.warn("THREE.Vector4: .add() now only accepts one argument. Use .addVectors( a, b ) instead."),this.addVectors(e,t)):(this.x+=e.x,this.y+=e.y,this.z+=e.z,void 0!==e.w&&(this.w+=e.w),this)}}),Object.assign(kn.Points.prototype,{raycast:function(e,t){var n=new kn.Matrix4,l=new kn.Ray,o=new kn.Sphere,i=new kn.Vector3;function r(e,t,n,o,i,r,a){var s=l.distanceSqToPoint(e);s<n&&(n=new kn.Vector3,l.closestPointToPoint(e,n),n.applyMatrix4(o),(o=i.ray.origin.distanceTo(n))<i.near||o>i.far||r.push({distance:o,distanceToRay:Math.sqrt(s),point:n,index:t,face:null,object:a}))}var a=this.geometry,s=this.matrixWorld,c=e.params.Points.threshold;if(null===a.boundingSphere&&a.computeBoundingSphere(),o.copy(a.boundingSphere),o.applyMatrix4(s),o.radius+=c,!1!==e.ray.intersectsSphere(o)){n.copy(s).invert(),l.copy(e.ray).applyMatrix4(n);var n=c/((this.scale.x+this.scale.y+this.scale.z)/3),u=n*n;if(a.isBufferGeometry){var c=a.index,n=a.attributes,d=n.position.array,p=n.position.itemSize;if(null!==c)for(var f=c.array,h=0,m=f.length;h<m;h++){var _=f[h];i.fromArray(d,_*p),r(i,_,u,s,e,t,this)}else for(var g=0,b=d.length/p;g<b;g++)i.fromArray(d,g*p),r(i,g,u,s,e,t,this)}else for(var v=a.vertices,y=0,w=v.length;y<w;y++)r(v[y],y,u,s,e,t,this)}}})):console.warn("Player: can not assign. Set THREE first.")}An.getColors=function(e,o){if(Ln(),Array.isArray(e)||(e=[e]),(o=o||{}).options=o.options||{},void 0!==o.positions&&Array.isArray(e)&&e.length!==o.positions.count)return console.error("getColors failed! arrayFuncs.length: "+e.length+" != positions.count: "+o.positions.count),o.colors;var t=Array.isArray(e)?e.length:o.positions.count;o.colors=o.colors||[],o.options.palette||o.options.setPalette();for(var i=0;i<t;i++){var n,r,a,s,l,c,u=Array.isArray(e)?e[i]:void 0;u instanceof kn.Vector4||o.positions&&4===o.positions.itemSize?(s=r=void 0,a=u.w,u.w instanceof Object&&u.w.func?(u.w.max&&(s=u.w.max),u.w.min&&(r=u.w.min),a=u.w.func):(o.options.setW(),r=o.options.scales.w.min,s=o.options.scales.w.max),a instanceof Function&&!o.options.player&&Pn&&(Pn=!1),s=o.options.palette.toColor(void 0===u?(new kn.Vector4).fromBufferAttribute(o.positions,i).w:a instanceof Function?a(o.options.playerOptions?o.options.playerOptions.min:0):a,r,s),o.colors.push(s.r,s.g,s.b)):o.colors instanceof kn.Float32BufferAttribute?n=new kn.Vector3(1,1,1):o.colors.push(1,1,1),void 0!==o.opacity?(l=0,c=getStandardNormalDistribution(0),group.children.forEach(function(e){if(e.userData.cloud)for(var t=0;t<e.geometry.attributes.position.count;t++){var n=getObjectPosition(e,t);l+=getStandardNormalDistribution(5*$t(camera,(new kn.Vector3).fromBufferAttribute(o.positions,i)).distanceTo(n))/c}}),void 0!==debug.opacity&&(l=debug.opacity),o.colors instanceof kn.Float32BufferAttribute?o.colors.setXYZW(i,n.x,n.y,n.z,l):o.colors.push(l)):o.colors.push(1)}return o.colors},An.traceLine=function e(c){var u;S(this,e);var d=[];Ln(),c.player&&(this.isVisible=function(){return!!c.player&&(u?u.visible:0!==d.length&&d[0].visible)},this.visible=function(t){if(!c.player)return!1;u?u.visible=t:d.forEach(function(e){e.visible=t})},this.addPoint=function(e,t,n){var o=e.geometry.attributes.position,i=4<=o.itemSize?new kn.Vector4(0,0,0,0):new kn.Vector3;i.fromArray(o.array,t*o.itemSize);var r=c.player?c.player.getSelectSceneIndex():0;if(null===c.playerOptions.max){if((r=Math.abs(r))<d.length-1){for(;r<d.length-1;)e.remove(d[d.length-1]),d.pop();return}var a=new kn.BufferGeometry,s=new Float32Array(6);a.setAttribute("position",new kn.BufferAttribute(s,3));s=new Float32Array(6);a.setAttribute("color",new kn.Float32BufferAttribute(s,3));s=new kn.Line(a,new kn.LineBasicMaterial({vertexColors:kn.VertexColors}));e.add(s),d[0]&&(s.visible=d[0].visible),i=(new kn.Vector3).copy(i);a=s.geometry.attributes.position.itemSize;return i.toArray(s.geometry.attributes.position.array,+a),(0===d.length?i:(new kn.Vector3).fromArray(d[d.length-1].geometry.attributes.position.array,+a)).toArray(s.geometry.attributes.position.array,0*a),s.geometry.attributes.position.needsUpdate=!0,void 0===n&&(n=new kn.Color(1,1,1)),An.setColorAttribute(s.geometry.attributes,0,0===d.length?n:(new kn.Color).fromArray(d[d.length-1].geometry.attributes.color.array,+a)),An.setColorAttribute(s.geometry.attributes,1,n),void d.push(s)}if(void 0===u){a=new kn.BufferGeometry;if(null!==c.playerOptions.max)if(c.playerOptions&&c.playerOptions.marks)l=c.playerOptions.marks;else{if(!c.player||!c.player.marks)return void console.error("Player.traceLine: MAX_POINTS = "+l+". Create Player first or remove all trace = true from all items of the arrayFuncs");l=c.player.marks}else l=r+1;s=new Float32Array(3*l);a.setAttribute("position",new kn.BufferAttribute(s,3));var l=new Float32Array(3*l);a.setAttribute("color",new kn.Float32BufferAttribute(l,3)),a.setDrawRange(r,r),(u=new kn.Line(a,new kn.LineBasicMaterial({vertexColors:kn.VertexColors}))).visible=!0,e.add(u)}u.geometry&&(delete u.geometry.boundingSphere,u.geometry.boundingSphere=null),(i=(new kn.Vector3).copy(i)).toArray(u.geometry.attributes.position.array,r*u.geometry.attributes.position.itemSize),u.geometry.attributes.position.needsUpdate=!0,void 0===n&&(n=new kn.Color(1,1,1)),An.setColorAttribute(u.geometry.attributes,r,n);i=u.geometry.drawRange.start,n=r+1-i;r<i&&(n=i+u.geometry.drawRange.count-(i=r)),u.geometry.setDrawRange(i,n)},this.remove=function(){void 0!==u&&(u.geometry.dispose(),u.material.dispose(),u.parent.remove(u))})},An.getItemSize=function(e){Ln();for(var t=0;t<e.length;t++)if(e[t]instanceof kn.Vector4)return 4;return 3},An.selectPlayScene=function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},n=void 0!==t.t?t.t:0,o=void 0!==t.index?t.index:void 0,i=t.options||new Tn;e.userData.t=n,An.selectMeshPlayScene(e,{t:n,options:i}),e.children.forEach(function(e){An.selectMeshPlayScene(e,{t:n,options:i})}),i.playerOptions.cameraTarget.setCameraTarget(i);e=i.playerOptions.cameraTarget.get();e&&e.setCameraPosition&&e.setCameraPosition(void 0===o)},An.assign=function(){Ln()},e.default=An,Object.defineProperty(e,"__esModule",{value:!0})});
