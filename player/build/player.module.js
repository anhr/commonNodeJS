	...
	return new SpriteText(
			...
			!isArrayFuncs ?
				...
				funcsIndex() instanceof THREE.Vector4 ||
					...
					color instanceof THREE.Color ?
						'\n' + lang$1.color + ': ' + new THREE.Color( color.r, color.g, color.b ).getHexString() :
		...
		(//opacity
			( intersection.object.geometry.attributes.ca === undefined ) ||
				...
				'' :
				'\n' + lang$1.opacity + ': ' + new THREE.Vector4().fromArray(
