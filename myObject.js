...
//				if (this.object3D && settings.options.guiSelectPoint && settings.options.guiSelectPoint.isSelectedMesh(this.object3D)) settings.options.guiSelectPoint.selectMesh(-1, this.object3D);
