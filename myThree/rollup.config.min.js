...
//Build myThree.module.min.js
//https://www.npmjs.com/package/uglify-es
const UglifyJS = require("uglify-es");
let code = fs.readFileSync( path.join( __dirname, 'build/myThree.module.js' ), "utf8" ),
    result = UglifyJS.minify( code );
if ( result.error !== undefined )
    console.log( result.error ); // runtime error, or `undefined` if no error
else fs.writeFileSync( "build/myThree.module.min.js", result.code, "utf8" );

code = fs.readFileSync(path.join(__dirname, 'build/myThree.js'), "utf8");
result = UglifyJS.minify(code);
if (result.error !== undefined)
    console.log(result.error); // runtime error, or `undefined` if no error
