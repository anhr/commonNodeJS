 ...
 *
 * http://www.apache.org/licenses/LICENSE-2.0
 */Co.cameraTarget=function e(){le(this,e);var i,o={boLook:!1},t={boLook:o.boLook,getDistanceToCamera:function(){return void 0!==this.distanceToCameraCur?this.distanceToCameraCur:this.distanceToCamera}};o.rotation={};var n,r=(t.rotation={},!1),a=!1;function s(e){So(),e=e||o,t.boMaual||(void 0!==e.boLook?t.boLook=e.boLook:t.boLook=o.boLook),t.camera=e.camera||o.camera,t.distanceToCamera=e.distanceToCamera||o.distanceToCamera||t.distanceToCamera||(new To.Vector3).copy(o.camera.position),e.rotation||(e.rotation={}),t.rotation.angle=e.rotation.angle||o.rotation.angle||0,t.rotation.axis=e.rotation.axis||o.rotation.axis||new To.Vector3(0,1,0)}this.get=function(e){if(e||i?i&&e&&!Object.is(i,e)&&console.error("Player.cameraTarget.get: options is ambiguous"):console.error("Player.cameraTarget.get: options = "+e),i=i||e,t.camera||a||!i.player||(o.camera=i.player.getSettings().cameraTarget.camera,o.camera&&s(),a=!0),t.camera)return t},this.init=function(e,t){if(t||i?i&&t&&!Object.is(i,t)&&console.error("Player.cameraTarget.init: options is ambiguous"):console.error("Player.cameraTarget.init: options = "+t),i=i||t,!1!==e.bodefault){if(r)return;void 0!==e.boLook&&(o.boLook=e.boLook,n=e.boLook)}else{if(!0!==e.boLook)return;r&&console.warn("playerCameraTarget().init(...): duplicate target point"),r=!0,void 0===n&&(o.boLook=!0)}o.camera=o.camera||e.camera||(i.player?i.player.getSettings().cameraTarget.camera:void 0),o.camera?(o.distanceToCamera=o.distanceToCamera||e.distanceToCamera,e.rotation=e.rotation||{},o.rotation.angle=o.rotation.angle||e.rotation.angle,o.rotation.axis=o.rotation.axis||e.rotation.axis,s(e)):console.error("playerCameraTarget().init(...): cameraTargetDefault.camera = "+o.camera)},this.changeTarget=function(e,t){So();var o=i.playerOptions.cameraTarget.get(),n=e.userData.player&&"function"!=typeof e.userData.player.arrayFuncs?e.userData.player.arrayFuncs[t]:{};n.cameraTarget||(n.cameraTarget={boLook:!1}),s(n.cameraTarget),o&&o.boLook?(e=eo(e,(new To.Vector3).fromArray(e.geometry.attributes.position.array,t*e.geometry.attributes.position.itemSize)),o.target=e):delete o.target},this.setCameraTarget=function(o){So();var e,t,n,i=o.playerOptions.cameraTarget.get(o),r=(i=i||i||{}).camera;r&&(i.distanceToCamera||(i.distanceToCamera=(new To.Vector3).copy(r.position)),i.distanceToCameraCur||(i.distanceToCameraCur=new To.Vector3),e=Co.getTime(),t=i.distanceToCamera,n=(new To.Vector3).copy(i.distanceToCameraCur),i.distanceToCameraCur.set(Co.execFunc(t,"x",e,o),Co.execFunc(t,"y",e,o),Co.execFunc(t,"z",e,o)),i.setCameraPosition||(i.setCameraPosition=function(){var e=i.target;if(i.boLook&&(e||!i.distanceToCameraCur.equals(n))){n.copy(i.distanceToCameraCur);var t=Co.getTime();if(r.position.copy(i.distanceToCameraCur),r.position.applyAxisAngle(i.rotation.axis,Co.execFunc(i.rotation,"angle",t,o)),!e){if(!Co.orbitControls)return;e=Co.orbitControls.target}r.position.add(e),r.lookAt(e),o.orbitControls&&(o.orbitControls.target.equals(e)||(o.orbitControls.target.copy(e),o.orbitControlsGui&&o.orbitControlsGui.setTarget(e)),o.orbitControls._listeners&&o.orbitControls._listeners.change[0]())}}),o.cameraGui&&o.cameraGui.update())}},Co.execFunc=function(e,t,o){var n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:{},i=e[t],r=n.a,a=n.b,s=void 0===i?"undefined":se(i);switch(void 0===o&&(o=n.playerOptions?n.playerOptions.min:0),s){case"undefined":return;case"string":i=new Function("t","a","b","return "+i);case"function":try{var l=i(o,r,a);if(void 0===l)throw"function returns "+l;return l}catch(e){throw console.error(e),e}case"number":return i;case"object":if(Array.isArray(i)){var c=function(e){return"function"==typeof u[e]?u[e](o,u,a):u[e]instanceof To.Color?u[e]:void 0};if(0===i.length)return void console.error('Player.execFunc: funcs["'+t+'"] array is empty');for(var u=i,d=i.length-1,p=null===n.playerOptions.max?1/0:n.playerOptions.max,f=n.playerOptions.min,m=(p-f)/d,h=f,g=p,y=0,v=d,b=0;b<i.length;b++)m*b+f<o&&(h=m*(y=b)+f,g=m*(v=b+1)+f);if("number"!=typeof u[y]){if("w"===t)return c(y);if("object"!==se(u[y]))return void console.error('Player.execFunc: funcs["'+t+'"] array item '+y+" typeof = "+se(u[y])+" is not number");for(b=0;b<i.length;b++){if(b===i.length-1)return u[b].v;if(v=(y=b)+1,h=u[y].t,g=u[v].t,h<=o&&o<g){var _=(u[v].v-u[y].v)/(g-h),x=u[y].v-_*h;return _*o+x}}return void console.error("Player.execFunc: value is not detected")}if(v>=i.length&&(v=y),"number"!=typeof u[v]){if("w"===t)return c(v);if("object"!==se(u[v]))return void console.error('Player.execFunc: funcs["'+t+'"] array item '+v+" typeof = "+se(u[v])+" is not number")}_=(u[v]-u[y])/(g-h),x=u[y]-_*h;return(isNaN(_)||isNaN(x))&&console.error("Player.execFunc: invalid x = "+_+" or y = "+x),_*o+x}return i.func?i.func instanceof Function?i.func(o,r,a):i.func:("w"!==t&&console.error('Player.execFunc: funcs["'+t+'"] object is not array'),i);default:console.error('Player.execFunc: Invalud typeof funcs["'+t+'"]: '+s)}},Co.selectMeshPlayScene=function(f){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};So();var t,m=e.t,h=e.options||{dat:!1};void 0===m&&(m=h.playerOptions.min),h.scales.setW(),!f.userData.player||h&&h.boPlayer&&f.userData.boFrustumPoints||(f.geometry&&(delete f.geometry.boundingSphere,f.geometry.boundingSphere=null),f.userData.player.selectPlayScene&&(t=function(e){for(;f.rotation[e]<0;)f.rotation[e]+=2*Math.PI;for(;f.rotation[e]>2*Math.PI;)f.rotation[e]-=2*Math.PI},f.userData.player.selectPlayScene(m),t("x"),t("y"),t("z")),function(o,i){if(f.geometry){var r,a,s=f.geometry.attributes,l=f.userData.player.arrayFuncs;if(void 0!==l){void 0===m&&console.error("setPosition: t = "+m),h&&void 0!==h.scales.w?(r=h.scales.w.min,a=h.scales.w.max):r=(a=d)-1;for(var c,u,d,p=0;p<l.length;p++)!function(){function e(e,t){e=Co.execFunc(c,e,m,h);void 0!==e&&(s.position[t](p,e),u=!0)}c=l[p],u=!1,e("x","setX"),e("y","setY"),e("z","setZ");var n=void 0;function t(){if(f.userData.player.palette)n=f.userData.player.palette.toColor(d,r,a);else{if(!h.palette){var e=255,t=255,o=255;return n=new To.Color("rgb("+e+", "+t+", "+o+")")}n=h.palette.toColor(d,r,a)}}"function"==typeof c.w?(d=c.w(m,o,i),a=h.scales.w?(r=h.scales.w.min,h.scales.w.max):(console.warn("Player.selectMeshPlayScene: Кажется эти экстремумы заданы неверно"),r=0,100),4<=s.position.itemSize&&s.position.setW(p,d),u=!0,t()):"object"===se(c.w)?c.w instanceof To.Color?n=c.w:(d=Co.execFunc(c,"w",m,h),void 0!==c.w.min&&(r=c.w.min),void 0!==c.w.max&&(a=c.w.max),t()):"number"==typeof c.w&&h.palette&&(n=h.palette.toColor(c.w,r,a)),n&&(!f.material instanceof To.ShaderMaterial&&f.material.vertexColors!==To.VertexColors&&console.error("Player.selectMeshPlayScene: Please set the vertexColors parameter of the THREE.PointsMaterial of your points to THREE.VertexColors. Example: vertexColors: THREE.VertexColors"),!Co.setColorAttribute(s,p,n)&&c instanceof To.Vector4&&(f.geometry.setAttribute("color",new To.Float32BufferAttribute(Co.getColors(l,{positions:f.geometry.attributes.position,options:h}),4)),Co.setColorAttribute(s,p,n)||console.error('Player.selectMeshPlayScene: the color attribute is not exists. Please use THREE.Vector3 instead THREE.Vector4 in the arrayFuncs or add "color" attribute'))),u&&(s.position.needsUpdate=!0),c.line&&c.line.addPoint&&c.line.addPoint(f,p,n),c.cameraTarget&&!0===c.cameraTarget.boLook&&h.playerOptions.cameraTarget.changeTarget(f,p)}()}}}(h?h.a:1,h?h.b:0),t="Player.selectMeshPlayScene: invalid mesh.scale.",f.scale.x<=0&&console.error(t+"x = "+f.scale.x),f.scale.y<=0&&console.error(t+"y = "+f.scale.y),f.scale.z<=0&&console.error(t+"z = "+f.scale.z),h&&h.guiSelectPoint&&(h.guiSelectPoint.setMesh(),-1!==(t=h.guiSelectPoint.getSelectedPointIndex())&&h.guiSelectPoint.isSelectedMesh(f)&&h.guiSelectPoint.setPosition({object:f,index:t})))},Co.setColorAttribute=function(e,t,o){"string"==typeof o&&(o=new To.Color(o));e=e.color||e.ca;return void 0!==e&&(e.setX(t,o.r),e.setY(t,o.g),e.setZ(t,o.b),e.needsUpdate=!0)},Co.getPoints=function(t,o){So(),Array.isArray(t)||(t=[t]),void 0===(o=o||{}).t&&(o.t=o.options&&o.options.player?o.options.player.getSettings().options.playerOptions.min:0);var n=o.options||new wo,e={palette:n.palette};n.setW(e);for(var i=e.scales.w.max,r=0;r<t.length;r++){var a=t[r];Array.isArray(a)?t[r]=new To.Vector4(void 0===a[0]?0:a[0],void 0===a[1]?0:a[1],void 0===a[2]?0:a[2],void 0===a[3]?i:a[3]):"object"===(void 0===a?"undefined":se(a))&&a instanceof To.Vector2==!1&&a instanceof To.Vector3==!1&&a instanceof To.Vector4==!1&&(void 0===a.vector?t[r]=new To.Vector4(void 0===a.x?0:a.x,void 0===a.y?0:a.y,void 0===a.z?0:a.z,void 0===a.w?0:a.w):a.vector instanceof To.Vector2==!0||a.vector instanceof To.Vector3==!0||a.vector instanceof To.Vector4==!0?a.vector instanceof To.Vector2==!0&&(t[r].vector=new To.Vector3(void 0===a.vector.x?0:a.vector.x,void 0===a.vector.y?0:a.vector.y,void 0===a.vector.z?0:a.vector.z)):4===a.vector.length?t[r].vector=new To.Vector4(void 0===a.vector[0]?0:a.vector[0],void 0===a.vector[1]?0:a.vector[1],void 0===a.vector[2]?0:a.vector[2],void 0===a.vector[3]?0:a.vector[3]):3===a.vector.length?t[r].vector=new To.Vector3(void 0===a.vector[0]?0:a.vector[0],void 0===a.vector[1]?0:a.vector[1],void 0===a.vector[2]?0:a.vector[2]):console.error("Player.getPoints(...) falied! item.vector.length = "+a.vector.length))}for(var s=[],r=0;r<t.length;r++){var l=function(e){return(c="number"==typeof c?new To.Vector4(c,0,0,0):c)instanceof To.Vector2||c instanceof To.Vector3||c instanceof To.Vector4?Co.execFunc(c,e,o.t,n):void 0!==c.vector?(void 0!==c.name&&(c.vector.name=c.name),c.trace&&n.player&&(c.vector.line=new Co.traceLine(n)),c.cameraTarget&&(c.vector.cameraTarget=c.cameraTarget,delete c.cameraTarget),t[r]=c.vector,c=c.vector,Co.execFunc(c,e,o.t,n)):void console.error("Player.getAxis().getPoints(): funcs.vector = "+c.vector)},c=t[r],l=c.vector instanceof To.Vector3==!0?new To.Vector3(l("x"),l("y"),l("z")):new To.Vector4(l("x"),l("y"),l("z"),l("w"));c.cameraTarget&&(c.cameraTarget.bodefault=!1,void 0===c.cameraTarget.boLook&&(c.cameraTarget.boLook=!0),n.playerOptions.cameraTarget.init(c.cameraTarget,n)),s.push(l)}return s};var To,Eo=!0;function So(){Me.isThree()?(To=Me.THREE,Object.assign(To.BufferGeometry.prototype,{setFromPoints:function(e,t){t=t||3;for(var o=[],n=0,i=e.length;n<i;n++){var r=e[n];o.push(r.x,r.y,r.z||0),4<=t&&o.push(r.w||0)}return this.setAttribute("position",new To.Float32BufferAttribute(o,t)),this}}),Object.assign(To.Vector4.prototype,{multiply:function(e){return this.x*=e.x,this.y*=e.y,this.z*=e.z,void 0!==e.w&&(this.w*=e.w),this}}),Object.assign(To.Vector4.prototype,{add:function(e,t){return void 0!==t?(console.warn("THREE.Vector4: .add() now only accepts one argument. Use .addVectors( a, b ) instead."),this.addVectors(e,t)):(this.x+=e.x,this.y+=e.y,this.z+=e.z,void 0!==e.w&&(this.w+=e.w),this)}}),Object.assign(To.Points.prototype,{raycast:function(e,t){var o=new To.Matrix4,l=new To.Ray,n=new To.Sphere,i=new To.Vector3;function r(e,t,o,n,i,r,a){var s=l.distanceSqToPoint(e);s<o&&(o=new To.Vector3,l.closestPointToPoint(e,o),o.applyMatrix4(n),(n=i.ray.origin.distanceTo(o))<i.near||n>i.far||r.push({distance:n,distanceToRay:Math.sqrt(s),point:o,index:t,face:null,object:a}))}var a=this.geometry,s=this.matrixWorld,c=e.params.Points.threshold;if(null===a.boundingSphere&&a.computeBoundingSphere(),n.copy(a.boundingSphere),n.applyMatrix4(s),n.radius+=c,!1!==e.ray.intersectsSphere(n)){o.copy(s).invert(),l.copy(e.ray).applyMatrix4(o);var o=c/((this.scale.x+this.scale.y+this.scale.z)/3),u=o*o;if(a.isBufferGeometry){var c=a.index,o=a.attributes,d=o.position.array,p=o.position.itemSize;if(null!==c)for(var f=c.array,m=0,h=f.length;m<h;m++){var g=f[m];i.fromArray(d,g*p),r(i,g,u,s,e,t,this)}else for(var y=0,v=d.length/p;y<v;y++)i.fromArray(d,y*p),r(i,y,u,s,e,t,this)}else for(var b=a.vertices,_=0,x=b.length;_<x;_++)r(b[_],_,u,s,e,t,this)}}})):console.warn("Player: can not assign. Set THREE first.")}Co.getColors=function(e,n){if(So(),Array.isArray(e)||(e=[e]),(n=n||{}).options=n.options||{},void 0!==n.positions&&Array.isArray(e)&&e.length!==n.positions.count)return console.error("getColors failed! arrayFuncs.length: "+e.length+" != positions.count: "+n.positions.count),n.colors;var t=Array.isArray(e)?e.length:n.positions.count;n.colors=n.colors||[],n.options.palette||n.options.setPalette();for(var i=0;i<t;i++){var o,r,a,s,l,c,u=Array.isArray(e)?e[i]:void 0;u instanceof To.Vector4||n.positions&&4===n.positions.itemSize?(s=r=void 0,a=u.w,u.w instanceof Object&&u.w.func?(u.w.max&&(s=u.w.max),u.w.min&&(r=u.w.min),a=u.w.func):(n.options.setW(),r=n.options.scales.w.min,s=n.options.scales.w.max),a instanceof Function&&!n.options.player&&Eo&&(Eo=!1),s=n.options.palette.toColor(void 0===u?(new To.Vector4).fromBufferAttribute(n.positions,i).w:a instanceof Function?a(n.options.playerOptions?n.options.playerOptions.min:0):a,r,s),n.colors.push(s.r,s.g,s.b)):n.colors instanceof To.Float32BufferAttribute?o=new To.Vector3(1,1,1):n.colors.push(1,1,1),void 0!==n.opacity?(l=0,c=getStandardNormalDistribution(0),group.children.forEach(function(e){if(e.userData.cloud)for(var t=0;t<e.geometry.attributes.position.count;t++){var o=getObjectPosition(e,t);l+=getStandardNormalDistribution(5*eo(camera,(new To.Vector3).fromBufferAttribute(n.positions,i)).distanceTo(o))/c}}),void 0!==debug.opacity&&(l=debug.opacity),n.colors instanceof To.Float32BufferAttribute?n.colors.setXYZW(i,o.x,o.y,o.z,l):n.colors.push(l)):n.colors.push(1)}return n.colors},Co.traceLine=function e(c){var u;le(this,e);var d=[];So(),c.player&&(this.isVisible=function(){return!!c.player&&(u?u.visible:0!==d.length&&d[0].visible)},this.visible=function(t){if(!c.player)return!1;u?u.visible=t:d.forEach(function(e){e.visible=t})},this.addPoint=function(e,t,o){var n=e.geometry.attributes.position;(s=4<=n.itemSize?new To.Vector4(0,0,0,0):new To.Vector3).fromArray(n.array,t*n.itemSize);var i=c.player?c.player.getSelectSceneIndex():0;if(null===c.playerOptions.max){if((i=Math.abs(i))<d.length-1){for(;i<d.length-1;)e.remove(d[d.length-1]),d.pop();return}var r=new To.BufferGeometry,a=new Float32Array(6);r.setAttribute("position",new To.BufferAttribute(a,3));a=new Float32Array(6);r.setAttribute("color",new To.Float32BufferAttribute(a,3));a=new To.Line(r,new To.LineBasicMaterial({vertexColors:To.VertexColors}));e.add(a),d[0]&&(a.visible=d[0].visible);var s=(new To.Vector3).copy(s),r=a.geometry.attributes.position.itemSize;return s.toArray(a.geometry.attributes.position.array,+r),(0===d.length?s:(new To.Vector3).fromArray(d[d.length-1].geometry.attributes.position.array,+r)).toArray(a.geometry.attributes.position.array,0*r),a.geometry.attributes.position.needsUpdate=!0,void 0===o&&(o=new To.Color(1,1,1)),Co.setColorAttribute(a.geometry.attributes,0,0===d.length?o:(new To.Color).fromArray(d[d.length-1].geometry.attributes.color.array,+r)),Co.setColorAttribute(a.geometry.attributes,1,o),void d.push(a)}if(void 0===u){r=new To.BufferGeometry;if(null!==c.playerOptions.max)if(c.playerOptions&&c.playerOptions.marks)l=c.playerOptions.marks;else{if(!c.player||!c.player.marks)return void console.error("Player.traceLine: MAX_POINTS = "+l+". Create Player first or remove all trace = true from all items of the arrayFuncs");l=c.player.marks}else l=i+1;a=new Float32Array(3*l);r.setAttribute("position",new To.BufferAttribute(a,3));var l=new Float32Array(3*l);r.setAttribute("color",new To.Float32BufferAttribute(l,3)),r.setDrawRange(i,i),(u=new To.Line(r,new To.LineBasicMaterial({vertexColors:To.VertexColors}))).visible=!0,e.add(u)}u.geometry&&(delete u.geometry.boundingSphere,u.geometry.boundingSphere=null),(s=(new To.Vector3).copy(s)).toArray(u.geometry.attributes.position.array,i*u.geometry.attributes.position.itemSize),u.geometry.attributes.position.needsUpdate=!0,void 0===o&&(o=new To.Color(1,1,1)),Co.setColorAttribute(u.geometry.attributes,i,o);s=u.geometry.drawRange.start,o=i+1-s;i<s&&(o=s+u.geometry.drawRange.count-(s=i)),u.geometry.setDrawRange(s,o)},this.remove=function(){void 0!==u&&(u.geometry.dispose(),u.material.dispose(),u.parent.remove(u))})},Co.getTime=function(){return Co.player?Co.player.getTime():0},Co.getItemSize=function(e){So();for(var t=0;t<e.length;t++)if(e[t]instanceof To.Vector4)return 4;return 3},Co.selectPlayScene=function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},o=void 0!==t.t?t.t:0,n=void 0!==t.index?t.index:void 0,i=t.options||new wo;e.userData.t=o,Co.selectMeshPlayScene(e,{t:o,options:i}),e.children.forEach(function(e){Co.selectMeshPlayScene(e,{t:o,options:i})}),i.playerOptions.cameraTarget.setCameraTarget(i);e=i.playerOptions.cameraTarget.get();e&&e.setCameraPosition&&e.setCameraPosition(void 0===n)},Co.assign=function(){So()};
/**
 * node.js version of the synchronous download of the file.
 * @author Andrej Hristoliubov https://anhr.github.io/AboutMe/
 *
 ...
 * You may obtain a copy of the License at
 */
void 0!==Yo&&(Me.dat=Yo);var nn,rn=(nn=function(){if(document.currentScript&&""!==document.currentScript.src)return document.currentScript.src;var e=document.getElementsByTagName("script");return""!==e[e.length-1].src?src:(new Error).stack.match(/(https?:[^:]*)/)[0]}()).substring(0,nn.lastIndexOf("/"));var an=new function(){var n=[];this.push=function(e){n.push(e)},this.display=function(t,o){n.forEach(function(e){e.style.display=e!==t&&o?"none":"block"})}},sn=[],g=function e(y,v){le(this,e);var b,_,x,w,t,C=Me.THREE,T=this;sn.push({createXDobjects:y,options:v}),1<sn.length||((v=v||{}).raycaster={onIntersection:function(e,t){var o,n;void 0!==e.object.userData.isInfo&&!e.object.userData.isInfo()||(void 0===(o=un(x))?((n=v.spriteText.rect?JSON.parse(JSON.stringify(v.spriteText.rect)):{}).displayRect=!0,n.backgroundColor="rgba(0, 0, 0, 1)",(o=No.getTextIntersection(e,{scales:v.scales,spriteOptions:{textHeight:v.spriteText.textHeight,fontColor:v.spriteText.fontColor,rect:n,group:x,center:{camera:b,canvas:w}}})).name=cn,o.scale.divide(x.scale),x.add(o)):o.position.copy(pos),v.renderer.domElement.style.cursor="pointer")},onIntersectionOut:function(){var e=!1;do{var t=un(x)}while(void 0!==t&&(x.remove(t),e&&console.error("Duplicate spriteTextIntersection"),e=!0),void 0!==t);v.renderer.domElement.style.cursor=v.cursor}},t={tag:"style"},void 0!==(v=new wo(v)).dat&&(so.sync(rn+"/../DropdownMenu/styles/gui.css",t),so.sync(rn+"/../DropdownMenu/styles/menu.css",t)),v.saveMeshDefault=function(e){e.userData.default=e.userData.default||{},e.userData.default.scale=new C.Vector3,e.userData.default.scale.copy(e.scale),e.userData.default.position=new C.Vector3,e.userData.default.position.copy(e.position),e.userData.default.rotation=new C.Euler,e.userData.default.rotation.copy(e.rotation)},function(){null===(c=void 0===v.elContainer?document.getElementById("containerDSE"):"string"==typeof v.elContainer?document.getElementById(v.elContainer):v.elContainer)&&("string"==typeof v.elContainer&&console.warn("The "+v.elContainer+" element was not detected."),c=document.createElement("div"),document.querySelector("body").appendChild(c)),an.push(c),c.innerHTML=Oo.sync(rn+"/canvasContainer.html");var i,r,a,e,s,l,t,o,c=c.querySelector(".container"),u=new C.Raycaster,d={},p=new C.Vector2;function n(){(b=new C.PerspectiveCamera(70,window.innerWidth/window.innerHeight,.01,10)).position.copy(v.camera.position),b.scale.copy(v.camera.scale),v.camera=b,v.point.sizePointsMaterial=100,v.cameraTarget&&(v.cameraTarget.camera=b,v.playerOptions.cameraTarget.init(v.cameraTarget,v)),(x=new C.Scene).background=new C.Color(0),x.fog=new C.Fog(0,250,1400),x.userData.optionsSpriteText={textHeight:.04},_=new C.Group,x.add(_),v.frustumPoints&&new tn(b,_,w,{options:v,optionsShaderMaterial:{point:{size:.01},stereo:{}}}),i=new C.WebGLRenderer({antialias:!0,canvas:w}),v.renderer=i,v.cursor=i.domElement.style.cursor,new No(i,v);var e=new on(x,{options:v,position:new C.Vector3(2*v.scale,2*v.scale,2*v.scale)}),t=new on(x,{options:v,position:new C.Vector3(-2*v.scale,-2*v.scale,-2*v.scale)});u.params.Points.threshold=.02,void 0!==u.setStereoEffect&&u.setStereoEffect({renderer:i,camera:b,stereoEffect:v.stereoEffect,raycasterEvents:!1}),v.raycaster.addParticle=function(e){void 0!==u.stereo&&u.stereo.addParticle(e)},v.raycaster.removeParticle=function(e){void 0!==u.stereo&&u.stereo.removeParticle(e)},v.dat.gui&&("undefined"!=typeof WebGLDebugUtils&&v.dat.gui.add({loseContext:function(e){w.loseContext()}},"loseContext"),void 0!==v.dat.gui.__closeButton.click&&v.dat.gui.__closeButton.click(),c.querySelector("#my-gui-container").appendChild(v.dat.gui.domElement)),new Co(_,{onSelectScene:function(e,t){v.boPlayer=!0,void 0!==v.frustumPoints&&v.frustumPoints.updateCloudPoints()},options:v,cameraTarget:{camera:b},onChangeScaleT:function(e){void 0!==v.player&&v.player.onChangeScale(e),_.children.forEach(function(e){void 0!==e.userData.player&&void 0!==e.userData.player.arrayFuncs&&"function"!=typeof e.userData.player.arrayFuncs&&e.userData.player.arrayFuncs.forEach(function(e){void 0!==e.line&&(e.line.remove(),e.line=new Co.traceLine(v))})})}}),v.player&&new v.player.PlayController,v.dat.gui&&(r=v.dat.gui.addFolder(ln.settings),v.player&&v.player.gui(r)),r&&Uo(x,v,{folder:r,options:{textHeight:.05,fov:b.fov}}),v.stereoEffect&&v.stereoEffect.gui({folder:r,onChangeMode:function(e){switch(e){case No.spatialMultiplexsIndexs.Mono:break;case No.spatialMultiplexsIndexs.SbS:case No.spatialMultiplexsIndexs.TaB:break;default:return void console.error("myThreejs: Invalid spatialMultiplexIndex = "+e)}void 0!==v.frustumPoints&&v.frustumPoints.updateGuiSelectPoint()}}),a=function(){i.domElement.style.position,i.domElement.style.left,i.domElement.style.top,i.domElement.style.width,i.domElement.style.height;var e=new C.Vector2;return i.getSize(e),{onFullScreenToggle:function(e){an.display(c.parentElement,!e)}}}(),new Ho(i,{fullScreen:{camera:b,onFullScreenToggle:function(e){a.onFullScreenToggle(e)}},options:v}),i.setSize(void 0!==v.canvas&&void 0!==v.canvas.width?v.canvas.width:w.clientWidth,void 0!==v.canvas&&void 0!==v.canvas.height?v.canvas.height:w.clientHeight),v.createOrbitControls(b,i,x),new Go(x,v),r&&(new Jo(v,{cameraTarget:{camera:b,orbitControls:v.orbitControls},pointsControls:function(e,t,o){},pointControls:function(e,t,o){}}),v.guiSelectPoint&&v.guiSelectPoint.add()),d.size=v.point.size;var o,n=v.dat.getCookieName("Point");if(v.dat&&v.dat.cookie.getObject(n,v.point,v.point),v.spriteText=v.spriteText||{},y&&y(_,v),v.frustumPoints&&v.frustumPoints.create(i),v.player||Co.selectPlayScene(_,{options:v}),v.boPlayer=!1,_.children.forEach(function(e){v.saveMeshDefault(e)}),v.dat.gui&&(Xo(v,r),new Ko(_,v,{folder:r}),!1!==v.orbitControls&&new qo(v,r),new Qo(b,v,r),(!1===v.axesHelper?v:v.axesHelper.options).scales,e.controls({group:_,folder:r,folderName:ln.light+" 1"}),t.controls({group:_,folder:r,folderName:ln.light+" 2"}),o=new $o(v.point,function(t){(t=void 0===t?v.point.size:t)<0&&(t=0),_.children.forEach(function(e){"Points"!==e.type||e.userData.boFrustumPoints||(void 0===e.material.uniforms?e.material.size=t/v.point.sizePointsMaterial:e.material.uniforms.pointSize.value=t)}),o.size.setValue(t),v.point.size=t,v.dat.cookie.setObject(n,v.point)},v,{folder:r,defaultPoint:d}),v.frustumPoints&&v.frustumPoints.gui(r),v.restoreSceneController(b,x)),_.children.forEach(function(e){void 0!==e.userData.raycaster&&void 0!==u.stereo&&(u.stereo.isAddedToParticles(e)||u.stereo.addParticle(e))}),void 0!==v.stats)try{l=new Stats,c.appendChild(l.dom)}catch(e){console.error(e+". Please import Stats from '../../../three.js/dev/examples/jsm/libs/stats.module.js';")}window.addEventListener("resize",f,!1)}function f(){var e;(v.canvasMenu?v.canvasMenu.isFullScreen():!v.canvas||!1!==v.canvas.fullScreen)?e=new C.Vector2(window.innerWidth,window.innerHeight):(e=new C.Vector2,i.getSize(e)),b.aspect=e.x/e.y,b.updateProjectionMatrix(),i.setSize(e.x,e.y),void 0!==v.frustumPoints&&v.frustumPoints.update()}function m(){void 0!==l&&l.begin(),o=requestAnimationFrame(m),h(),void 0!==l&&l.end()}function h(){(v.stereoEffect&&v.stereoEffect.render?v.stereoEffect:i).render(x,b),void 0===e&&(e=new C.Vector3),void 0===s&&(s=v.point.size),(!e.equals(b.position)||s!=v.point.size||void 0!==v.frustumPoints&&v.frustumPoints.animate())&&(e.copy(b.position),s=v.point.size,_.children.forEach(function(e){if(e instanceof C.Points!=!1)if(void 0!==e.geometry.attributes.size){void 0!==v.point.opacity&&(e.material.uniforms.opacity.value=v.point.opacity);for(var t=myPoints.getGlobalScale(e),o=new C.Vector3(b.position.x/t.x,b.position.y/t.y,b.position.z/t.z),t=(t.x+t.y+t.z)/3,n=0;n<e.geometry.attributes.position.count;n++){var i=getObjectPosition(e,n),i=new C.Vector3(i.x,i.y,i.z).distanceTo(o);e.geometry.attributes.size.setX(n,Math.tan((void 0!==e.userData.shaderMaterial.point&&void 0!==e.userData.shaderMaterial.point.size?e.userData.shaderMaterial:v).point.size)*i*t*1),e.geometry.attributes.size.needsUpdate=!0}}else e.material.size=s/v.point.sizePointsMaterial})),v.guiSelectPoint&&v.guiSelectPoint.render&&v.guiSelectPoint.render()}w=c.querySelector("canvas"),c.addEventListener("mousemove",function(e){{var t,o,n;void 0!==u&&(void 0!==u.stereo?u.stereo.onDocumentMouseMove(e):(e.preventDefault(),t=i.domElement.offsetLeft,o=i.domElement.offsetTop,n=new C.Vector2,i.getSize(n),p.x=e.clientX/n.x*2-1-t/n.x*2,p.y=2*-(e.clientY/n.y)+1+o/n.y*2))}if(1!=e.buttons)return;h()},!1),c.addEventListener("pointerdown",function(e){if(void 0===u)return;if(void 0!==u.stereo)return void u.stereo.onDocumentMouseDown(e);u.setFromCamera(p,b),0<(t=u.intersectObjects(_.children)).length&&(e=t[0],function(e,t){void 0!==v.axesHelper&&"Points"===t.object.type?v.axesHelper.exposePosition(e):alert('You are clicked the "'+t.object.type+'" type object.'+(void 0===t.index?"":" Index = "+t.index+".")+" Position( x: "+e.x+", y: "+e.y+", z: "+e.z+" )")}(getPosition(e),e))},{capture:!0}),(w="undefined"!=typeof WebGLDebugUtils?WebGLDebugUtils.makeLostContextSimulatingCanvas(w):w).addEventListener("webglcontextlost",function(e){e.preventDefault(),void 0!==o?window.cancelAnimationFrame(o):console.error("myThreejs.create.onloadScripts: requestId = "+o),clearThree(x),u=void 0,a.onFullScreenToggle(!0),alert(ln.webglcontextlost)},!1),w.addEventListener("webglcontextrestored",function(){console.warn("webglcontextrestored"),n(),m()},!1),n(),m(),sn.shift();var g=sn.shift();void 0!==g&&T.create(g.createXDobjects,g.options)}())},ln={defaultButton:"Default",settings:"Settings",webglcontextlost:"The user agent has detected that the drawing buffer associated with a WebGLRenderingContext object has been lost.",light:"Light",opacity:"Opacity"};"ru"===xo()&&(ln.defaultButton="Восстановить",ln.name="Имя",ln.settings="Настройки",ln.webglcontextlost="Пользовательский агент обнаружил, что буфер рисунка, связанный с объектом WebGLRenderingContext, потерян.",ln.light="Свет",ln.opacity="Непрозрачность");var cn="spriteTextIntersection";function un(e){var t;return e.children.forEach(function(e){"Sprite"===e.type&&e.name===cn&&(t=e)}),t}g.MyPoints=zo,g.StereoEffect={spatialMultiplexsIndexs:No.spatialMultiplexsIndexs},g.ColorPicker=fo,g.getWorldPosition=eo,g.limitAngles=function(t){function e(e){for(;t[e]>2*Math.PI;)t[e]-=2*Math.PI}e("x"),e("y"),e("z")},g.Player=Co,g.three=Me,window.__myThree__=window.__myThree__||{},window.__myThree__.boMyThree&&console.error("myThree: duplicate myThree. Please use one instance of the myThree class."),window.__myThree__.boMyThree=!0,e.default=g,Object.defineProperty(e,"__esModule",{value:!0})});
