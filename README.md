...
[Example](https://raw.githack.com/anhr/commonNodeJS/master/AxesHelper/Examples/index.html).
* [HyperSphere](https://en.wikipedia.org/wiki/N-sphere). [README.md](https://github.com/anhr/commonNodeJS/tree/master/HyperSphere).[HyperSphere API](https://raw.githack.com/anhr/commonNodeJS/master/HyperSphere/jsdoc/index.html).
	Examples:
	...
	* Random Vertice. [README.md](https://github.com/anhr/commonNodeJS/blob/master/graphicObjects/circle.md).
...
* myObject.js [MyObject](https://github.com/anhr/commonNodeJS/blob/master/myObject.js) is base class for my threejs objects.
[MyObject API](https://raw.githack.com/anhr/commonNodeJS/master/jsdoc/MyObject/index.html).
